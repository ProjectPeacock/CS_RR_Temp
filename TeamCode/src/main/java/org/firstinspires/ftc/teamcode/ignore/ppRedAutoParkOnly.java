...
@Autonomous(name = "Red Auto Park Only", group = "Peacock")
@Disabled

public class ppRedAutoParkOnly extends LinearOpMode {

    private final static TmpHWProfile robot = new TmpHWProfile();
    private LinearOpMode opMode = this;
    private State state = State.DETECTION;

    public ppRedAutoParkOnly(){
