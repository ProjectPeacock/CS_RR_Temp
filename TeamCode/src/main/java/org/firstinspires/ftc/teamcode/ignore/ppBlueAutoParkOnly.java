...
@Autonomous(name = "Blue Auto Park Only", group = "Peacock")
@Disabled

public class ppBlueAutoParkOnly extends LinearOpMode {

    private final static TmpHWProfile robot = new TmpHWProfile();
    private LinearOpMode opMode = this;
    private State state = State.DETECTION;

    public ppBlueAutoParkOnly(){
     ...
     */
    enum State {
        DETECTION, PLACE_PIXEL1, CYCLE1, CYCLE2, CYCLE3, PARK, HALT;
    }   // end of enum State
