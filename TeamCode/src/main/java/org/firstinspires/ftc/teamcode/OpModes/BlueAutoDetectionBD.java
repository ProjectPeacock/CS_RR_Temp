...
@Autonomous(name = "Blue Auto - Backdrop Side", group = "Peacock")
//@Disabled

public class BlueAutoDetectionBD extends LinearOpMode {
        ...
        while(opModeIsActive()) {
            switch (state) {
                ...
                case PLACE_RIGHT:
                    ...
                    // strafe into position to place yellow pixel
                ...
                case PLACE_CENTER:
                    ...
                    // strafe into position to place pixels
                    drive.driveDistance(0.3, -90, 10);
                ...
                case PLACE_LEFT:
                    ...
                    // strafe into position to score the yellow pixel
