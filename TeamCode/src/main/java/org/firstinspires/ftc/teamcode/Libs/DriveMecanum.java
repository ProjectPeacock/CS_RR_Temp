...
public class DriveMecanum {
     ...
     * Constructor method
     */
    public DriveMecanum(TmpHWProfile myRobot, LinearOpMode myOpMode){
        robot = myRobot;
        opMode = myOpMode;
...
//            opMode.sleep(5);
    ...
    public void intakePower(double power){
        robot.motorIntake.setPower(power);
    }

    public void dumpBucket(){
        robot.servoBucket.setPosition(robot.BUCKET_DUMP);
    }
    ...
    public void armOut(){
        robot.servoArm.setPosition(robot.ARM_OUT);
    }
    ...
    public void dumpPixel(){
        robot.servoArm.setPosition(robot.ARM_OUT);
        opMode.sleep(750);
       // robot.servoGate.setPosition(robot.GATE_OPEN);
        robot.servoBucket.setPosition(robot.BUCKET_DUMP);
        opMode.sleep(1000);
        robot.servoBucket.setPosition(robot.BUCKET_RESET);
        robot.servoArm.setPosition(robot.ARM_RESET);
    ...
    public void liftPosition(int position){
        robot.servoGate.setPosition(robot.GATE_CLOSE);
        robot.servoBucket.setPosition(robot.BUCKET_UP);
    ...
    public void resetLift(){
        ...
        robot.motorLift.setTargetPosition(robot.LIFT_BOTTOM);
    }
    ...
    public void deployIntakeMid(){
        robot.servoIntakeRight.setPosition(robot.INTAKE_MID_RIGHT);
        robot.servoIntakeLeft.setPosition(robot.INTAKE_MID_LEFT);
