...
@Autonomous(name = "Red Auto - Front Side", group = "Peacock")
//@Disabled

public class RedAutoDetectionFront extends LinearOpMode {
        ...
        while(opModeIsActive()) {
            switch (state) {
                ...
                case PLACE_LEFT:
                    ...
                    drive.driveDistance(0.3, 0, 27);

                    // turn towards the backdrop
                    drive.PIDRotate(-90, 0.5);

                    // Drive to the parking area
                    drive.driveDistance(0.3, 180, 73);
                ...
                case LEFT_BD:
                    ...
                    // drive forward for the pixel to drop
                    drive.driveDistance(0.1, 0, 1);
                ...
                case RIGHT_BD:
                    ...
                    // strafe to scoring position
                    drive.driveDistance(0.3, -90, 40);

                    // drive back into the backdrop
                    drive.driveDistance(0.1, 180, 7);
     ...
     */
    enum State {
        DETECTION, PLACE_LEFT, LEFT_BD, PLACE_CENTER, CENTER_BD, PLACE_RIGHT, RIGHT_BD, CYCLE1, PARK, HALT
    }   // end of enum State
